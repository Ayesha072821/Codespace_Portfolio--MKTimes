                ...
                if(mysqli_num_rows($r) !=0)     // if any row is retrieved
                    {
                       ...
                       //try to send the email
                        if (mail($to_email, $subject, $body, $headers)) {
                            ...
                            echo "</br></br><h5 id='confirmation '>Order Confirmation Email have been sent to your Registered Email.</h5></br></ br>";
                             } else {
...
echo "<h2 id='order_place'>Thanks for your order.Your orderNumber is #".$order_id."</h2></br></br>"; 
